...
> **BẮT BUỘC trước khi làm bất cứ việc gì trong skill này:** đọc
> [TEACH-PREFERENCES.md](./TEACH-PREFERENCES.md) nằm cùng thư mục và tuân theo
> toàn bộ rule trong đó. File này định nghĩa chất lượng dạy (phần A) và định
> dạng bài học HTML (phần B). Bộ asset dùng chung nằm ở `./assets/`.
